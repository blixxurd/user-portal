      ...
      <div class="flex">
        ...
        <div class="w-1/2 rounded overflow-hidden shadow-lg border-orange-500 border-t-2">
          <div class="px-6 py-4">
            ...
            <hr class="my-3">
            <router-link to="/account/edit" class="pb-3 font-medium text-orange-500 hover:text-orange-400 focus:outline-none focus:underline transition ease-in-out duration-150 block">
              Edit Account
            </router-link>
